...
class __TwigTemplate_b968d5b8e5642bfb0c374fb179b9cf571656fe8314f4173c53f02d1231b0de3a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["i"] ?? null) + 1) % 4) == 0)) {
  ...
  <div class=\"mt-2\">
    ...
    <body>
        <h2 style=\"color: black;\" class=\"ask\">Ask Your Questions Here</h2>
        <div id=\"chat-messages\"></div>
        <textarea id=\"message-input\" placeholder= \"Ask your questions here\"></textarea>
...
function send_message() {
    ...
    fetch( \"index.php?route=chat/message&product_id=";
        // line 690
        echo ($context["product_id"] ?? null);
        echo "\", {
        method: \"POST\",
